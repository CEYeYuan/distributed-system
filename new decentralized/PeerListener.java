...
public class PeerListener extends Thread{
	...
	public PeerListener(Socket socket,ConcurrentHashMap<String,ObjectOutputStream> map,String myself,Location mylocation,AtomicInteger token, ConcurrentHashMap<String, Client>clientTable, AtomicInteger seq, Maze maze, BlockingQueue eventQueue){
		//server as sever
		this.socket=socket;
		this.map=map;
		this.myself=myself;
	...
	public PeerListener(ConcurrentHashMap<String,ObjectOutputStream> map,String peer_name,Location peer_location,String myself,Location mylocation,AtomicInteger token, ConcurrentHashMap<String, Client> clientTable,AtomicInteger seq, Maze maze, BlockingQueue eventQueue){
		...
		try{
	        ...
	        *****************************************************************/
			...
			while(true){
                ...
                System.out.println("Received type of package: " + packetFromPeer.type + packetFromPeer.event);
                ...
                //cannot go into ???
//		        else if(packetFromPeer.type==MPacket.MISSILE){
//		        	System.out.println("Value is xxxxxxxxxxxxxxxxxxxxxxxxxxxxx: " + packetFromPeer.type);
	                ...
	                while(!queue.isEmpty()){
	                    if(queue.peek().sequenceNumber==seq.get()){
	                        ...
	                        if(received.event == MPacket.UP){
	                            ...
	                            client.fire(); 
	                        }else if(received.event == MPacket.PROJ){
	                        	System.out.println("Value is xxxxxxxxxxxxxxxxxxxxxxxxxxxxx: " + received.type);
